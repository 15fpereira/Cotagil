    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 service-box service-center">
                ...
                <div class="service-content">
                    <h4>Cotar Produtos</h4>
                    <p>Aqui voçê ira cotar o preços dos produtos, após a solicitação do condominio.</p>
                </div>
            </div>
            <!-- End Service Icon 3 -->
            ...
            <div class="col-md-3 col-sm-6 service-box service-center">
                ...
                <div class="service-content">
                    ...
                    <p>Aqui voçê acessa as ultimas listas de cotações.</p>
                </div>
            </div>
            <!-- End Service Icon 4 -->
        ...
        <div class="big-title text-center">
            <h1>outros serviços <strong>Fornecedor</strong></h1>
            <p class="title-desc">Seja bem vindo!!!</p>
        </div>
        <!-- End Big Heading -->
